...
func NewResponseError(code, statusCode int, msg string, args ...interface{}) error {
	res := &ResponseError{
		Code:       code,
		Message:    fmt.Sprintf(msg, args...),
		StatusCode: statusCode,
...
func New400Response(msg string, args ...interface{}) error {
	return NewResponseError(400, 400, msg, args...)
}

// New500Response 创建错误码为500的响应错误
func New500Response(msg string, args ...interface{}) error {
	return NewResponseError(500, 500, msg, args...)
}
