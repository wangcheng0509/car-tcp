...
type IMsgHandle interface {
	...
	AddRouter(msgID uint8, router IRouter)
	AddRouterSlices(msgId uint8, handler ...RouterHandler) IRouterSlices
	Group(start, end uint8, Handlers ...RouterHandler) IGroupRouterSlices
