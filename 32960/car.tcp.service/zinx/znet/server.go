...
func (s *Server) AddRouterSlices(msgID uint8, router ...ziface.RouterHandler) ziface.IRouterSlices {
	if !s.RouterSlicesMode {
...
func (s *Server) Group(start, end uint8, Handlers ...ziface.RouterHandler) ziface.IGroupRouterSlices {
	if !s.RouterSlicesMode {
		panic("Server RouterSlicesMode is false")
	}
