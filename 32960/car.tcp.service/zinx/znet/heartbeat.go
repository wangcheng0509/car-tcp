...
type HeartbeatChecker struct {
	...
	msgID        uint8                  // Heartbeat message ID(心跳的消息ID)
...
func (h *HeartbeatChecker) BindRouter(msgID uint8, router ziface.IRouter) {
...
func (h *HeartbeatChecker) BindRouterSlices(msgID uint8, handlers ...ziface.RouterHandler) {
...
func (h *HeartbeatChecker) MsgID() uint8 {
	return h.msgID
}
